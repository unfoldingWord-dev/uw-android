...
/** 
 * Master of DAO (schema version 102): knows all DAOs.
*/
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        LanguageLocaleDao.createTable(db, ifNotExists);
        ...
        BibleChapterDao.createTable(db, ifNotExists);
        StoriesChapterDao.createTable(db, ifNotExists);
        StoryPageDao.createTable(db, ifNotExists);
        SigningOrganizationDao.createTable(db, ifNotExists);
        AudioBookDao.createTable(db, ifNotExists);
        AudioChapterDao.createTable(db, ifNotExists);
        VerificationDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        LanguageLocaleDao.dropTable(db, ifExists);
        ...
        BibleChapterDao.dropTable(db, ifExists);
        StoriesChapterDao.dropTable(db, ifExists);
        StoryPageDao.dropTable(db, ifExists);
        SigningOrganizationDao.dropTable(db, ifExists);
        AudioBookDao.dropTable(db, ifExists);
        AudioChapterDao.dropTable(db, ifExists);
        VerificationDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(LanguageLocaleDao.class);
        ...
        registerDaoClass(BibleChapterDao.class);
        registerDaoClass(StoriesChapterDao.class);
        registerDaoClass(StoryPageDao.class);
        registerDaoClass(SigningOrganizationDao.class);
        registerDaoClass(AudioBookDao.class);
        registerDaoClass(AudioChapterDao.class);
        registerDaoClass(VerificationDao.class);
    }
