...
public class Version extends model.UWDatabaseModel  implements java.io.Serializable {
    ...
    public JSONObject getAsPreloadJson(Context context){
        ...
        Language parentLanguage = this.getLanguage();
        Project parentProject = parentLanguage.getProject();
        ...
        try {
            ...
            sideLoadJson.put("sources", getSourcesAsJson(context));
            return sideLoadJson;
        }
        catch (JSONException e){
            e.printStackTrace();
    ...
    private String loadSource(String url, Context context){
